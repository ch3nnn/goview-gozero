...
type AddScreenProjectResp struct {
	...
	Project *ScreenProject `protobuf:"bytes,1,opt,name=project,proto3" json:"project,omitempty"` // screen_project
}
...
func (x *AddScreenProjectResp) GetProject() *ScreenProject {
	if x != nil {
		return x.Project
	}
	return nil
...
type ScreenData struct {
	...
	Id        int64  `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`                                // ID
	ProjectId int64  `protobuf:"varint,2,opt,name=project_id,json=projectId,proto3" json:"project_id,omitempty"` // project ID
	UserId    int64  `protobuf:"varint,3,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`          // 用户 ID
	Content   string `protobuf:"bytes,4,opt,name=content,proto3" json:"content,omitempty"`                       // 内容数据
...
func (x *ScreenData) Reset() {
	*x = ScreenData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pb_screen_proto_msgTypes[12]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ScreenData) Descriptor() ([]byte, []int) {
	return file_pb_screen_proto_rawDescGZIP(), []int{12}
}

func (x *ScreenData) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *ScreenData) GetProjectId() int64 {
	if x != nil {
		return x.ProjectId
	}
	return 0
...
func (x *ScreenData) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *ScreenData) GetContent() string {
	if x != nil {
		return x.Content
	}
	return ""
...
func (x *ScreenData) GetCreateAt() int64 {
	if x != nil {
		return x.CreateAt
	}
	return 0
...
type AddScreenDataReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	ProjectId int64  `protobuf:"varint,1,opt,name=project_id,json=projectId,proto3" json:"project_id,omitempty"` // project ID
	UserId    int64  `protobuf:"varint,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`          // 用户 ID
	Content   string `protobuf:"bytes,3,opt,name=content,proto3" json:"content,omitempty"`                       // 内容数据
}

func (x *AddScreenDataReq) Reset() {
	*x = AddScreenDataReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pb_screen_proto_msgTypes[13]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *AddScreenDataReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AddScreenDataReq) ProtoMessage() {}

func (x *AddScreenDataReq) ProtoReflect() protoreflect.Message {
	mi := &file_pb_screen_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AddScreenDataReq.ProtoReflect.Descriptor instead.
func (*AddScreenDataReq) Descriptor() ([]byte, []int) {
	return file_pb_screen_proto_rawDescGZIP(), []int{13}
}

func (x *AddScreenDataReq) GetProjectId() int64 {
	if x != nil {
		return x.ProjectId
	}
	return 0
...
func (x *AddScreenDataReq) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *AddScreenDataReq) GetContent() string {
	if x != nil {
		return x.Content
	}
	return ""
...
type AddScreenDataResp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *AddScreenDataResp) Reset() {
	*x = AddScreenDataResp{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pb_screen_proto_msgTypes[14]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *AddScreenDataResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AddScreenDataResp) ProtoMessage() {}

func (x *AddScreenDataResp) ProtoReflect() protoreflect.Message {
	mi := &file_pb_screen_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AddScreenDataResp.ProtoReflect.Descriptor instead.
func (*AddScreenDataResp) Descriptor() ([]byte, []int) {
	return file_pb_screen_proto_rawDescGZIP(), []int{14}
}

type SelectScreenDataByIdReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SelectScreenDataByIdReq) Reset() {
	*x = SelectScreenDataByIdReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pb_screen_proto_msgTypes[15]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *SelectScreenDataByIdReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SelectScreenDataByIdReq) ProtoMessage() {}

func (x *SelectScreenDataByIdReq) ProtoReflect() protoreflect.Message {
	mi := &file_pb_screen_proto_msgTypes[15]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SelectScreenDataByIdReq.ProtoReflect.Descriptor instead.
func (*SelectScreenDataByIdReq) Descriptor() ([]byte, []int) {
	return file_pb_screen_proto_rawDescGZIP(), []int{15}
}

func (x *SelectScreenDataByIdReq) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *SelectScreenDataByIdReq) GetProjectId() int64 {
	if x != nil {
		return x.ProjectId
	}
	return 0
...
type SelectScreenDataByIdResp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	ScreenData *ScreenData `protobuf:"bytes,1,opt,name=screen_data,json=screenData,proto3" json:"screen_data,omitempty"` // screen_data
}

func (x *SelectScreenDataByIdResp) Reset() {
	*x = SelectScreenDataByIdResp{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pb_screen_proto_msgTypes[16]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *SelectScreenDataByIdResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SelectScreenDataByIdResp) ProtoMessage() {}

func (x *SelectScreenDataByIdResp) ProtoReflect() protoreflect.Message {
	mi := &file_pb_screen_proto_msgTypes[16]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SelectScreenDataByIdResp.ProtoReflect.Descriptor instead.
func (*SelectScreenDataByIdResp) Descriptor() ([]byte, []int) {
	return file_pb_screen_proto_rawDescGZIP(), []int{16}
}

func (x *SelectScreenDataByIdResp) GetScreenData() *ScreenData {
	if x != nil {
		return x.ScreenData
	}
	return nil
...
var file_pb_screen_proto_rawDesc = []byte{
	...
	0x65, 0x6c, 0x22, 0x47, 0x0a, 0x14, 0x41, 0x64, 0x64, 0x53, 0x63, 0x72, 0x65, 0x65, 0x6e, 0x50,
	0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x52, 0x65, 0x73, 0x70, 0x12, 0x2f, 0x0a, 0x07, 0x70, 0x72,
	0x6f, 0x6a, 0x65, 0x63, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x73, 0x63,
	0x72, 0x65, 0x65, 0x6e, 0x2e, 0x53, 0x63, 0x72, 0x65, 0x65, 0x6e, 0x50, 0x72, 0x6f, 0x6a, 0x65,
	0x63, 0x74, 0x52, 0x07, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x22, 0x98, 0x02, 0x0a, 0x16,
	0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x53, 0x63, 0x72, 0x65, 0x65, 0x6e, 0x50, 0x72, 0x6f, 0x6a,
	...
	,
	...
	0x74, 0x65, 0x41, 0x74, 0x22, 0x64, 0x0a, 0x10, 0x41, 0x64, 0x64, 0x53, 0x63, 0x72, 0x65, 0x65,
	0x6e, 0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x71, 0x12, 0x1d, 0x0a, 0x0a, 0x70, 0x72, 0x6f, 0x6a,
	...
	0x09, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0x13, 0x0a, 0x11, 0x41, 0x64,
	0x64, 0x53, 0x63, 0x72, 0x65, 0x65, 0x6e, 0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x73, 0x70, 0x22,
	0x48, 0x0a, 0x17, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x53, 0x63, 0x72, 0x65, 0x65, 0x6e, 0x44,
	...
	,
...
var file_pb_screen_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_pb_screen_proto_goTypes = []interface{}{
	...
	(*ScreenData)(nil),                  // 12: screen.ScreenData
	(*AddScreenDataReq)(nil),            // 13: screen.AddScreenDataReq
	(*AddScreenDataResp)(nil),           // 14: screen.AddScreenDataResp
	(*SelectScreenDataByIdReq)(nil),     // 15: screen.SelectScreenDataByIdReq
	(*SelectScreenDataByIdResp)(nil),    // 16: screen.SelectScreenDataByIdResp
}
var file_pb_screen_proto_depIdxs = []int32{
	0,  // 0: screen.AddScreenProjectResp.project:type_name -> screen.ScreenProject
	0,  // 1: screen.SelectScreenProjectByIdResp.screen_project:type_name -> screen.ScreenProject
	1,  // 2: screen.SelectScreenProjectListReq.filter:type_name -> screen.ScreenProjectFilter
	0,  // 3: screen.SelectScreenProjectListResp.results:type_name -> screen.ScreenProject
	12, // 4: screen.SelectScreenDataByIdResp.screen_data:type_name -> screen.ScreenData
	2,  // 5: screen.Screen.InsertScreenProject:input_type -> screen.AddScreenProjectReq
	4,  // 6: screen.Screen.UpdateScreenProject:input_type -> screen.UpdateScreenProjectReq
	6,  // 7: screen.Screen.DeleteScreenProject:input_type -> screen.DelScreenProjectReq
	8,  // 8: screen.Screen.SelectScreenProjectById:input_type -> screen.SelectScreenProjectByIdReq
	10, // 9: screen.Screen.SelectScreenProjectList:input_type -> screen.SelectScreenProjectListReq
	13, // 10: screen.Screen.InsertScreenData:input_type -> screen.AddScreenDataReq
	15, // 11: screen.Screen.SelectScreenDataById:input_type -> screen.SelectScreenDataByIdReq
	3,  // 12: screen.Screen.InsertScreenProject:output_type -> screen.AddScreenProjectResp
	5,  // 13: screen.Screen.UpdateScreenProject:output_type -> screen.UpdateScreenProjectResp
	7,  // 14: screen.Screen.DeleteScreenProject:output_type -> screen.DelScreenProjectResp
	9,  // 15: screen.Screen.SelectScreenProjectById:output_type -> screen.SelectScreenProjectByIdResp
	11, // 16: screen.Screen.SelectScreenProjectList:output_type -> screen.SelectScreenProjectListResp
	14, // 17: screen.Screen.InsertScreenData:output_type -> screen.AddScreenDataResp
	16, // 18: screen.Screen.SelectScreenDataById:output_type -> screen.SelectScreenDataByIdResp
...
func file_pb_screen_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pb_screen_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pb_screen_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AddScreenDataReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pb_screen_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AddScreenDataResp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pb_screen_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SelectScreenDataByIdReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pb_screen_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SelectScreenDataByIdResp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
