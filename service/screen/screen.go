...
import (
	...
	screenServer "github.com/ch3nnn/goview-gozero/service/screen/internal/server/screen"
...
var (
	...
	// configFile 配置文件路径
	configFile = flag.String("f", "etc/screen.yaml", "the config file")
...
func main() {
	...
	s := zrpc.MustNewServer(c.RpcServerConf, func(grpcServer *grpc.Server) {
		pb.RegisterScreenServer(grpcServer, screenServer.NewScreenServer(ctx))
