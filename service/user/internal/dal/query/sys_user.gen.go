...
func newSysUser(db *gorm.DB, opts ...gen.DOOption) sysUser {
	...
	_sysUser.DepID = field.NewInt64(tableName, "dep_id")
	_sysUser.PosID = field.NewString(tableName, "pos_id")
...
func (s *sysUser) updateTableName(table string) *sysUser {
	...
	s.DepID = field.NewInt64(table, "dep_id")
	s.PosID = field.NewString(table, "pos_id")
...
func (s *sysUser) fillFieldMap() {
	...
	s.fieldMap["dep_id"] = s.DepID
	s.fieldMap["pos_id"] = s.PosID
}
